	...
	<?php if ( $remote_icon_sets ) { ?>
		<?php foreach( $remote_icon_sets as $icon_set ) { ?>
			...
			<li>
				...
				<button class="btn btn-small" data-loading-text="<?php _e( 'Installing...', 'wptouch-pro' ); ?>" data-base-path="<?php echo $icon_set->dir_base; ?>" data-install-url="<?php echo $icon_set->download_url; ?>"><i class="blue-cloud"></i><?php _e( 'Install', 'wptouch-pro' ); ?></button>
