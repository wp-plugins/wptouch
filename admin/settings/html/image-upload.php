<div class="<?php wptouch_admin_the_setting_name(); ?>_wrap uploader" id="<?php wptouch_admin_the_setting_name(); ?>"> 
	...
	<button id="<?php wptouch_admin_the_setting_name(); ?>_upload" data-esn="<?php wptouch_admin_the_encoded_setting_name(); ?>" class="upload btn btn-small"><?php _e( 'Upload', 'wptouch-pro' ); ?></button>

	<button class="delete btn btn-small" <?php if ( !$image ) { echo 'style="display: none;"'; } ?>><?php _e( 'Delete', 'wptouch-pro' ); ?></button>
