	...
	<div class="postbox">
		<h3><span class="icon-options">&nbsp;</span><?php _e( "Default &amp; Custom Icon Pool", "wptouch" ); ?></h3>
			...
			<div class="left-content">
				...
				<p><?php echo sprintf( __( "These files will be stored in this folder we create: %s%s/uploads/wptouch/custom-icons", "wptouch"), "<strong>", '' . compat_get_wp_content_dir( 'wptouch' ). '', "</strong>" ); ?></p>
