				...
				<ul class="wptouch-make-li-italic">
					<li>
						<select name="wptouch-language">
							...
							<option value="ca_ES"<?php if ( $wptouch_settings['wptouch-language'] == "ca_ES" ) echo " selected"; ?>>Catalan</option>
							...
							<option value="pt_BR"<?php if ( $wptouch_settings['wptouch-language'] == "pt_BR" ) echo " selected"; ?>>Português (Brasil)</option>
