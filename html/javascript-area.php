	...
	<div class="wptouch-right-content">
		<ul>
			<li>
				...
				<label class="label" for="enable-cats-button"><?php _e( "Enable categories in the header", "wptouch" ); ?><a href="#cats-info" class="wptouch-fancylink">(moreinfo)</a></label>
			...
			<li>
				...
				<label class="label" for="enable-login-button"><?php _e( "Enable login from the header", "wptouch" ); ?><a href="#login-info" class="wptouch-fancy">(moreinfo)</a></label>
			...
			<label class="label" for="enable-page-coms"> <?php _e( "Enable comments on pages", "wptouch" ); ?> <a href="#page-coms-info" class="wptouch-fancy">?</a></label>
			...
			<li>
				...
				<label class="label" for="enable-regular-default"><?php _e( "First-time mobile users will see regular (non-mobile) site", "wptouch" ); ?> <a href="#reg-info" class="wptouch-fancy">(moreinfo)</a></label>
...
<label class="label" for="enable-gzip"> <?php _e( "Enable GZIP compression", "wptouch" ); ?> <small>(<?php _e( "speeds up page loads, may conflict with other plugins", "wptouch" ); ?>)</small></label>
 ...
 -->				
			...
			<li>
				...
				<label class="label" for="enable-exclusive"> <?php _e( "Enable WPtouch exclusive mode", "wptouch" ); ?> <a href="#exclusive-info" class="wptouch-fancy">?</a></label>
