		...
		<ul>
			<li>
				...
				<div id="cats-info" style="display:none">
					...
					<?php _e( "This will add a categories drop-down item in the WPtouch sub header beside the Login (if also enabled), Search, and Menu link buttons.", "wptouch" ); ?><br /><br /><?php _e( "It will display your top categories, and show the number of entries they have in each.", "wptouch" ); ?>
				</div>
			</li>
<li>
...
<label for="enable-login-button"><?php _e( "Enable login from the header", "wptouch" ); ?><a href="#login-info" class="wptouch-fancy">?</a>
<div id="login-info" style="display:none"><h2><?php _e( "More Info", "wptouch" ); ?></h2><?php _e( "This will add a login drop-down item in the WPtouch sub header beside the Categories (if also enabled), Search, and Menu link buttons.", "wptouch" ); ?><br /><br /><?php _e( "It will display a username/password drop-down, and allows users to login + be automatically re-directed without seeing the WP admin.", "wptouch" ); ?></div></label>
</div>
