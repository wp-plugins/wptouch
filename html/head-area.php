		...
		<div id="wptouch-head-colour">
			<div id="wptouch-head-title">
				...
				<div id="wptouch-head-links">
					<ul>
						<li><?php echo sprintf(__( "%sGet WPtouch Pro%s", "wptouch" ), '<a href="http://www.bravenewcode.com/products/wptouch-pro/?utm_source=wptouch&utm_medium=web&utm_campaign=top" target="_blank">','</a>'); ?> | </li>
	...
	<div class="bnc-clearer"></div>
		...
		<div id="wptouch-news-support">
			...
			<h3>&nbsp;</h3>
				...
				<p id="find-out-more"><a href="http://www.bravenewcode.com/products/wptouch-pro/?utm_source=wptouch&utm_medium=web&utm_campaign=find-out-more" target="_blank"><?php _e( "Find Out More &rsaquo;", "wptouch" ); ?></a></p>
				</div>
			</div>
