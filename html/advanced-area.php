	...
	<div class="right-content">
		<ul>
			...
			<li>
				...
				<label class="label" for="enable-zoom"><?php _e( "Allow zooming on content", "wptouch" ); ?> <a href="#zoom-info" class="fancylink" rel="tooltip" title="<?php _e( "This will allow users to zoom in and out on content.", "wptouch" ); ?>">?</a></label>
			</li>
			<li>
				...
				<label class="label" for="enable-cats-button"><?php _e( "Enable Categories tab in the header", "wptouch" ); ?> <a href="#cats-info" class="fancylink" rel="tooptip" title="hey">?</a></label>
