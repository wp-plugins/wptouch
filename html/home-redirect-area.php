...
<div class="wptouch-itemrow home-page-block">
	<div class="wptouch-item-desc">
		...
		<p><?php sprintf( _e( "For your home page, WPtouch respects the front page behavior you've defined in the %sWordPress -> Reading Options%s.", "wptouch"), '<a href="options-reading.php">', '</a>' ); ?></p>
	</div>
