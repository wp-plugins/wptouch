...
<html xmlns="http://www.w3.org/1999/xhtml" lang=<?php echo '"' . substr( WPLANG, 0, 2 ) . '"'; ?>>
<head profile="http://gmpg.org/xfn/11">
	...
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/style.min.css?ver=1.9.22.1" type="text/css" media="screen" />
