<?php global $is_ajax; $is_ajax = isset($_SERVER['HTTP_X_REQUESTED_WITH']);
...
<div class="post" id="post-<?php the_ID(); ?>">
					...
					<a class="post-arrow-down" id="arrow-down-<?php the_ID(); ?>" href="javascript:new Effect.toggle($('entry-<?php the_ID(); ?>'),'Appear', {duration: 0.5});new Effect.toggle($('entry-<?php the_ID(); ?>'),'Appear', {duration: 0.5});Element.setStyle('arrow-<?php the_ID(); ?>', {display:'block'} );Element.setStyle('arrow-down-<?php the_ID(); ?>', {display:'none'} );" style="display:none"></a>
