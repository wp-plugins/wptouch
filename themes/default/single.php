...
bloginfo('name'); ?>- <?php the_title();?>&body=<?php _e( "Check out this post:", "wptouch" ); ?>%20<?php the_permalink() ?>" onclick="return confirm('<?php _e( "Mail a link to this post?", "wptouch" ); ?>');" id="omail"></a></li>
		...
		<li><a href="/" onclick="wptouch_toggle_bookmarks();" id="obook"></a></li>
  	...
  	<div id="twitter-box" style="display:none">
		<ul>
			<li><a href="#" onclick="window.location='tweetie:'+window.location"><img src="<?php echo compat_get_plugin_url( 'wptouch' ); ?>/themes/core/core-images/twitter/tweetie.png" alt="tweetie" /> <?php _e( "Post to Tweetie", "wptouch" ); ?></a></li>
			<li><a href="#" onclick="window.location='twitterrific:///post?message='+escape(window.location)"><img src="<?php echo compat_get_plugin_url( 'wptouch' ); ?>/themes/core/core-images/twitter/twitteriffic.png" alt="twitteriffic" /> <?php _e( "Post to Twitteriffic", "wptouch" ); ?></a></li>
			<li><a href="#" onclick="window.location='twit:'+window.location"><img src="<?php echo compat_get_plugin_url( 'wptouch' ); ?>/themes/core/core-images/twitter/twittelator.png" alt="twittelator" /> <?php _e( "Post to Twittelator Pro", "wptouch" ); ?></a></li>
		</ul>
	</div>
