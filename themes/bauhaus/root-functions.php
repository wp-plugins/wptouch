...
define( 'BAUHAUS_THEME_VERSION', '1.0.5' );
...
add_filter( 'wptouch_the_post_thumbnail', 'bauhaus_handle_has_thumbnail' );
...
function bauhaus_setting_defaults( $settings ) {
	...
	// Bauhaus font default
//	$settings->typography_sets = 'lato_roboto';

	// Theme colors
	$settings->bauhaus_background_color = '#f5f4ee';
	$settings->bauhaus_header_color = '#526873';
	$settings->bauhaus_link_color = '#00b3cc';
	$settings->bauhaus_post_page_header_color = '#d8ff7a';
...
//			'cloud',
	...
	foundation_register_theme_color( 'bauhaus_header_color', __( 'Header & Menu', 'wptouch-pro' ), 'a', 'body, header, .wptouch-menu, #search-dropper', BAUHAUS_SETTING_DOMAIN );
		...
		array(
			wptouch_add_setting( 
				...
				array(
					...
					//'squares' => __( 'Squares', 'wptouch-pro' ),
